        ...
        for y in list(gr[0].graph.adj[x].keys()):
            ...
            for u in different:
                ...
                for v in neighbours_u:
                    ...
                    copy_gr[1] = False
                    copy_gr[0].graph.remove_edge(x, y)
                    copy_gr[0].graph.remove_edge(u, v)
                    copy_gr[0].graph.add_edge(x, u)
                    copy_gr[0].graph.add_edge(y, v)
                    if not isomorphism.is_isomorphic(gr[0].graph, copy_gr[0]):
